            ...
            children: [
                    ...
                    child: TextButton(
                        onPressed: () {
                          Navigator.of(context).push(
                            MaterialPageRoute(
                              builder: (context) => const TeacherAdd(),
                            ),
                          );
                        },
              ...
              Center(
                child: FutureBuilder<QuerySnapshot<Map<String, dynamic>>>(
                  future: FirebaseFirestore.instance.collection('Lærer').get(),
                              ...
                              ListTile(
                                ...
                                onTap: () {
                                  ...
                                  Navigator.of(context)
                                      .push(
                                    MaterialPageRoute(
                                      builder: (context) => const TeacherEdit(),
                                    ),
                                  )
                                      .then(
                                    (value) {
...
class _TeacherAddState extends State<TeacherAdd> {
  ...
  Future<void> _saveData() async {
    ...
    try {
      await FirebaseFirestore.instance.collection('lærer').add(data);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text('Legg til en ny Lærer'),
      ),
      body: Form(
        key: _formKey,
        child: Container(
