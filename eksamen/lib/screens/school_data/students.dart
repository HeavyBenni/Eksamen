...
class Elev extends StatefulWidget {
  ...
  @override
  State<Elev> createState() => _ElevState();
}
                              ...
                              ListTile(
                                      ...
                                      onPressed: () {
                                        try {
                                          ...
                                          ScaffoldMessenger.of(context)
                                              .showSnackBar(
                                            const SnackBar(
                                              content: Text('Elev slettet'),
                                            ),
                                          );
                                          //Navigator.of(context).pop();
                                        } catch (error) {
                                          print('Error adding elev: $error');
                                        }
                                      },
                                ...
                                onTap: () {
                                  ...
                                  Navigator.of(context)
                                      .push(
                                    MaterialPageRoute(
                                      builder: (context) => const ElevEdit(),
                                    ),
                                  )
                                      .then(
                                    (value) {
...
class ElevAdd extends StatefulWidget {
  const ElevAdd({super.key});

  @override
  State<ElevAdd> createState() => _ElevAddState();
}

class _ElevAddState extends State<ElevAdd> {
  ...
  Future<void> _saveData() async {
    ...
    try {
      await FirebaseFirestore.instance.collection('elev').add(data);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text('Legg til en ny Elev'),
      ),
      body: Form(
        key: _formKey,
        child: Container(
...
class ElevEdit extends StatefulWidget {
  const ElevEdit({Key? key});

  @override
  State<ElevEdit> createState() => _ElevEditState();
}

class _ElevEditState extends State<ElevEdit> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
